...
// const HeroSection = () => {
//   return (
//     <div className="min-h-screen px-6 py-10 bg-white dark:bg-black text-white">
...
//           <Typewriter />
//           <p className="text-base sm:text-lg text-gray-300 font-light max-w-md">
...
//         <div className="flex-1 mt-10 md:mt-0 flex justify-center">
//           <img
//             src="https://scontent.fdac24-1.fna.fbcdn.net/v/t39.30808-6/502503803_683905464271639_2523339238655852757_n.jpg"
//             alt="Mehedi Hasan"
...
const HeroSection = () => {
  return (
    <div className="pl-24 min-h-screen px-6 py-10 bg-white dark:bg-black text-white">
      <main className="flex flex-col md:flex-row items-center max-w-7xl mx-auto">
        <div className="flex-1 space-y-8">
          <p className="text-xl font-light font-serif">Hi, I’m</p>
          <h1 className="text-4xl sm:text-5xl font-bold font-serif">Mehedi Hasan</h1>
