...
const links = [
  ...
  { href: "https://facebook.com/yourusername", icon: <FaFacebookF size={18} />, label: "Facebook" },
  { href: "https://linkedin.com/in/yourusername", icon: <FaLinkedinIn size={18} />, label: "LinkedIn" },
  { href: "https://twitter.com/yourusername", icon: <FaTwitter size={18} />, label: "Twitter" },
];
